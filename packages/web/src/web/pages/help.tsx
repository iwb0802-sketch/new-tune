  ...
  return (
    <div style={{ padding: 20, display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <Section id="measure" title="대표건반 측정 & 조율 커브 원리" kicker="STRETCH CURVE">
        ...
        <Steps
          items={[
            "측정 탭에서 안내된 대표 건반을 하나씩 선택해 칩니다.",
            "해당 음이 마이크에 안정적으로 잡히는지 확인합니다.",
            "소리를 내면서 표시되는 스트로브·센트값을 관찰합니다.",
            "+, - 버튼으로 초록색이 되는 지점을 찾습니다.",
            "초록색이 된 지점에 나오는 센트값을 현재 센트값으로 두고 확정 버튼을 누릅니다.",
            "확정된 상태로 그래프가 완성된 후 그래프 곡선 모양을 확인합니다.",
            "그래프 허용 범위 안에 들어간다면 실기에서 좋은 점수를 받을 수 있습니다.",
          ]}
        />
